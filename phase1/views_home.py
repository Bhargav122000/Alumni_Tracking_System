# this file include functionality to display home page of website (phase1)
...
# function to the url - 'home_p1'
# functionality - for displaying the home page of website (phase1)
def home(request):
    if request.user.is_authenticated:
        ...
        return render(request,'phase1/home.html',{'day':d.day,'month':month_dic[d.month],'year':d.year,'week':d.strftime("%A"),'desc1':desc[0],'desc2':desc[1],'link':link})
    else :
